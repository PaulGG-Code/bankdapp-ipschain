    ...
    <div ref={ref} className="flex flex-col max-w-md gap-6 p-5 mx-auto tracking-wide bg-black border rounded-md shadow-2xl xs:rotate-0 -rotate-2 border-neutral-600 font-audiowide">
      ...
      <div>
        ...
        <div className="grid grid-cols-5 gap-4">
          ...
          <button className="flex items-center justify-center col-span-3 gap-2 p-2 px-4 transition-all bg-green-400 rounded-md hover:scale-105"
      ...
      <div>
        ...
        <div className="grid grid-cols-5 gap-4">
          ...
          <button className="flex items-center justify-center col-span-3 gap-2 p-2 px-4 transition-all bg-red-400 rounded-md hover:scale-105"
