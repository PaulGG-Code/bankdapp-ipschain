...
export const ToolsSection = () => {
  return (
    <div className="grid grid-cols-3 xs:grid-cols-1 xs:h-auto xs:gap-8 xs:py-4 h-[8rem] place-items-center bg-neutral-600/20 px-4">
      <CustomLink href="https://ipsprotocol.xyz/" className="flex items-center justify-center w-[100%] h-[100%] hover:bg-neutral-800 hover:scale-105 transition-all">
        <div>
          <Image
            src="/images/ips_logo_with_name.png"
            alt="tools"
            width={167}
            height={40} />
        </div>
