        ...
        <div className="relative grid h-full grid-cols-2 gap-10 p-4 pt-40 pb-32 my-auto overflow-hidden border-b xl:px-8 xs:grid-cols-1 border-neutral-600/50">
          <div className="z-10 flex flex-col gap-8">
            <div className="flex items-center gap-2 px-4 rounded-full bg-neutral-200 max-w-max">
              ...
              <span className="text-sm font-semibold">Live on IPSChain Testnet</span>
            </div>
            ...
            <button className="flex items-center gap-2 p-2 px-4 transition-all bg-red-500 rounded-md max-w-max hover:scale-105 text-white" onClick={focusContractCard}>
          ...
          <div className="absolute right-0 bottom-0 bg-gradient-to-l from-red-600/10 to-neutral-900/10 w-[50%] h-full">
          </div>
        </div>
